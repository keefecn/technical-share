...
算法1两个词语的相似度取决于词语之间的共性（COMMONALITY））和个性(DIFFERENE)。
...
**方法2****：分类。通过UNICODE****字符集范围比对。语系分析，再语系下语言语种识别。**
...
　　　　 ![image-20191201152125324](../../media/ai/ai_nlp_004.png)

　　给线性序列中的每个元素打上标签集合中的某个标签：

　　　　 ![image-20191201152139891](../../media/ai/ai_nlp_004_02.png)
...
Ø WINDOWS: C:\\Users\\keefe\\AppData\\Roaming\\nltk_data
...
(1) 基于Trie树（前缀树、字母树）结构实现高效的词图扫描，生成句子中汉字所有可能成词情况所构成的有向无环图（DAG)；
...
说明：词典每词占一行；每一行分三部分，第一部分为词语，中间部分为词频，最后部分为词性（可省略，ns为地点名词），用空格隔开。
...
jieba.analyse.extract_tags(sentence, topK=5)
...
上图显示了Tika的四个模块的体系结构：
*  语言检测机制 Language identifier
*  MIME检测机制 MIME type identifier
*  Parser接口
*  Tika Facade 类
...
Ø 我爱自然语言处理 [www.52nlp.cn/](http://www.52nlp.cn/)

Ø 自然语言处理百科 http://wiki.52nlp.cn/ 

Ø 中国语言文字网 http://www.china-language.gov.cn/bakeoff08/

Ø 语言理解 https://www.luis.ai/ 
...
Ø 张华平.ICTCLAS[EB/OL]. [2009-08-15].http://mtgroup.ict.ac.cn/~zhp/ICTCLAS.htm. 2002.

Ø 黄昌宁.赵海 [中文分词十年回顾 ](http://d.wanfangdata.com.cn/ExternalResource-jsjyy201008012^1.aspx) 中文信息学报, 2007(3)
...
Ø 中科院中文信息处理平台http://www.nlp.org.cn/

Ø [北大计算语言所](http://icl.pku.edu.cn) http://icl.pku.edu.cn/

Ø [中科院NLP Group](http://mtgroup.ict.ac.cn)　 http://mtgroup.ict.ac.cn

Ø [哈工大智能技术与自然语言处理研究室](http://www.insun.hit.edu.cn/) http://www.insun.hit.edu.cn/ 

Ø [NLP Group](http://mtgroup.ict.ac.cn)　 http://mtgroup.ict.ac.cn
...
n Bakeoff-6, Bakeoff-2010 

n Bakeoff-5, Bakeoff-2009 

n 第一届中国中文信息学会汉语处理评测暨第四届国际中文自然语言处理Bakeoff ([Bakeoff-4, Bakeoff-2007, 2008](http://www.china-language.gov.cn/bakeoff08/bakeoff-08_basic.html)) 中国北京

n [Bakeoff-3, Bakeoff-2006](http://www.sighan.org/bakeoff2006/)悉尼 http://sighan.cs.uchicago.edu/bakeoff2006/

n Bakeoff-2, Bakeoff-2005韩国济州岛

n 第一届国际中文分词竞赛Bakeoff-1, Bakeoff- 2003日本札幌
