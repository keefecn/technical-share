...
|                |          | 性能 nums/sec |         |                                              |
| -------------- | -------- | ------------- | ------- | -------------------------------------------- |
| 框架名         | 代码行数 | 单进程        | 并发100 | 依赖组件                                     |
| Django         | 120K     | 255           | x       | babel(10k)                                   |
| Tornago        | 42K      | 387           | 918     |                                              |
| Flask          | 6.5K     | 342           | 1694    | Jinjia2(12k), MarkupSafe(22k),   click(6.6k) |
| uwsgi + Django |          | 280           | 2947    |                                              |
| uwsgi + Flask  |          | 343           | 4651    |                                              |
...
| 工具        | 简介                                                         | 安装                                                         | 使用                                    |
| ----------- | ------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------------------- |
| node.js     | 建立在谷歌Chrome的JavaScript引擎(V8引擎)的Web应用程序框架。最新版本8.11.3 | nvm install 5.1.0   或者   apt-get install nodejs            | node -v                                 |
| npm/   cnpm | 用来安装npm包。cnpm为中国区。                                |                                                              | npm -v   npm instal*   [xxx]            |
| nvm         | node.js的包管理工具。                                        | cur*   -o- https://raw.githubusercontent.com/creationix/nvm/v0.33.1/install.sh \|   bash | nvm   --version   nvm install [version] |
| bower       | npm包，前端管理工具，专门用来管理WEB前端依赖包（JS/CSS/IMAGES/fonts） | npm   install bower                                          | # 初始化生成bower.json   $ bower   init |
| gulp        | nodejs代码部署发布工具。                                     | npm install gulp --globa*   npm install gulp --save-dev      | gulp [js_pipe]   gulp deploy            |
...
| Express | 基于node.js的框架。    | npm install express--save-dev |      |
| ejs     | 模板引擎               |                               |      |
| github  | github   api           |                               |      |
|         |                        |                               |      |
|         |                        |                               |      |
...
cd sacdl-project
npm instal*   # 自动查找package.json里依赖包并安装
bower install
...
| http       | WEB服务器                                                    |      |
| Express    | 一个最小的，灵活的Node.js   Web应用程序框架，它提供了一套强大的功能来开发Web和移动应用程序。 |      |
| **JXcore** |                                                              |      |
|            |                                                              |      |
