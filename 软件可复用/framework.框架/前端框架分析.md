...
| gulp        | nodejs代码部署发布工具。                                     | npm install gulp -g                                          | gulp [js_pipe]   gulp deploy           |
| grunt       | 脚手架，用来自动化构建                                       | npm install -g grunt-cli                                     |                                        |
| webpack     | 打包                                                         | npm install webpack@xx -g                                    |                                        |
...
* npm init会产生初始的package.json
* npm run xx 是最常用，用来启动各种命令如dev build lint ...
...
| 模块名        | 说明                                                         | 安装                          | 使用                                                       |
| ------------- | ------------------------------------------------------------ | ----------------------------- | ---------------------------------------------------------- |
| express       | 基于node.js的框架。脚手架。<br>它提供了一套强大的功能来开发Web和移动应用程序。 | npm install express--save-dev | var express = require('express');<br/>var app = express(); |
| babel-runtime |                                                              |                               |                                                            |
...
| ejs           | 模板引擎                                                     |                               |                                                            |
| github        | github   api                                                 |                               |                                                            |
| cross-env     | 设置环境变量，兼容windows和linux                             | npm install cross-env         | cross-env NODE-ENV=prod                                    |

备注：参数选项--save-dev为保存到开发目录，-g 保存到全局目录。
...
[4]:  TS基础  https://blog.csdn.net/qq_39403733/article/details/93756705

[5]:  ts语法总结 https://blog.csdn.net/qq_15701939/article/details/83934608
...
Jinja2是基于python的[模板引擎](https://baike.baidu.com/item/模板引擎)，功能比较类似于于[PHP](https://baike.baidu.com/item/PHP/9337)的[smarty](https://baike.baidu.com/item/smarty)，[J2ee](https://baike.baidu.com/item/J2ee)的[Freemarker](https://baike.baidu.com/item/Freemarker)和[velocity](https://baike.baidu.com/item/velocity)。 它能完全支持[unicode](https://baike.baidu.com/item/unicode)，并具有集成的沙箱执行环境，应用广泛。jinja2使用[BSD](https://baike.baidu.com/item/BSD)授权。
