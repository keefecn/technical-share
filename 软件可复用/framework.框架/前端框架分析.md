...
- [mustache.js](https://github.com/janl/mustache.js)：JavaScript最精简的 {{mustaches}} 模板
- [handlebars.js](https://github.com/wycats/handlebars.js/)：Mustache 模板语言的扩展。
- [nunjucks](https://mozilla.github.io/nunjucks/)：Mozilla 出品，丰富且强大的 JavaScript模板语言。
- [hogan.js](https://github.com/twitter/hogan.js)：是 Mustache 模板语言的编译器。
- [doT](https://github.com/olado/doT)：最快速简洁的 JavaScript模板引擎，适用于 Node.js 和浏览器。
- [dustjs](https://github.com/linkedin/dustjs/)：适用于浏览器和 Node.js 的异步模板。
- [eco](https://github.com/sstephenson/eco/)：嵌入式的 CoffeeScript 模板。
- [JavaScript-Templates](https://github.com/blueimp/JavaScript-Templates)：轻量（小于 1KB）、快速、强大且无依赖的 JavaScript模版引擎。
- [t.js](https://github.com/jasonmoo/t.js)：小巧的 JavaScript模板框架，压缩后约为 400 字节。
- [Pug](https://github.com/pugjs/pug)：健壮的、优雅且功能丰富的 nodejs 模板引擎。`（曾用名：Jade）`
- [EJS](https://github.com/mde/ejs)：高效的 JavaScript模板。
...
- [swig](https://github.com/paularmstrong/swig)：一款简单、强大、可扩展的基于 Node.js 和 浏览器的 JavaScript模板引擎。`（已停止维护）`
- [EHTML](https://github.com/Guseyn/EHTML)：一款实现零编写 JavaScript的 HTML 框架。
...
<div id="footer">
    {% block  footer %}
    <script>This is JavaScriptcode </script>
    {% endblock %}
</div>
</body>
</html>
...
JQuery，顾名思义，也就是JavaScript和查询（Query），即是辅助JavaScript开发的库。JQuery是一个兼容多浏览器的JavaScript库，核心理念是write less,do more(写得更少,做得更多)。

JQuery在2006年1月由美国人John Resig在纽约的barcamp发布，吸引了来自世界各地的众多JavaScript高手加入，由Dave Methvin率领团队进行开发。截至 2021 年，有将近 84% 的移动页面使用 jQuery。2018 年，GitHub 宣布从GitHub.com 的前端代码中完全移除了jQuery。Bootstrap 5删除 jQuery。

JQuery是继[Prototype](http://baike.baidu.com/view/1217697.htm)之后又一个优秀的JavaScript库。它是轻量级的js库 ，它兼容[CSS3](http://baike.baidu.com/view/1713027.htm)，还兼容各种浏览器（IE 6.0+, FF 1.5+, Safari 2.0+, Opera 9.0+），JQuery2.0及后续版本将不再支持IE6/7/8浏览器。JQuery使用户能更方便地处理HTML（标准通用标记语言下的一个应用）、events、实现动画效果，并且方便地为网站提供[AJAX](http://baike.baidu.com/subview/1641/5762264.htm)交互。JQuery还有一个比较大的优势是，它的文档说明很全，而且各种应用也说得很详细，同时还有许多成熟的插件可供选择。JQuery能够使用户的html页面保持代码和html内容分离，也就是说，不用再在html里面插入一堆js来调用命令了，只需要定义id即可。
...
| [Bootstrap](https://getbootstrap.com/)  | Twitter           | 2011.8 | MIT      | [twbs/bootstrap](https://github.com/twbs/bootstrap)   | [Docs](https://getbootstrap.com/docs/5.1/) [Readme](https://github.com/twbs/bootstrap#readme) | 5.1.2  | Bootstrap 主要针对桌面端，Bootstrap3 提出移动优先。<br>Bootstrap 主要基于 jQuery 进行 JavaScript处理，支持 LESS 来做 CSS 的扩展。 | jQuery+LESS | IE6/7不友好                  |
| [React](https://reactjs.org/)           | Facebook          | 2013.5 | MIT      | [facebook/react](https://github.com/facebook/react)   | [Readme](https://github.com/facebook/react#readme)                                            | 17.0.2 | React 是一个用于构建用户界面的 JavaScript库。React主要用于构建UI.                                                     | JSX         |                           |
| [Vue.js](https://github.com/vuejs/core) | 阿里巴巴...           | 2014   | MIT      | [vuejs/core](https://github.com/vuejs/core)           | [Readme](https://github.com/vuejs/core#readme)                                                | 3.2.29 | 渐进式JavaScript框架。                                                                                  | 上手最容易。      |                           |
...
AngularJS在版本2（全面使用TypeScript）之后改名Angular，第N版以Angular N的形式命名。

表格  Angular版本列表

| 版本        | 发布时间        | 说明                                                                                                                                                 |
| --------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| AngularJS | 2010        | AngularJS是一款由Google维护的开源JavaScript函式庫，用來協助單一頁面應用程式運行。它的目标是透過MVC模式（MVC）功能增强基于浏览器的应用，使开发和测试变得更加容易。<br>2022年1月，**Angular 官方团队宣布不再对 AngularJS 框架做支持**。 |
| Angular 2 | 2016-09-14  | 2.x系列最后一个版本是1.0.28(2016-09-14)。性能上得到显著的提高，能很好的支持 Web 开发组件。                                                                                         |
| 4         | 2016年12月13日 | 4.x系列最后一个版本是4.3(2017-03-23)。Angular 4向后兼容Angular2。                                                                                                 |
| 5         | 2017年11月1日  | 主要改进包括支持渐进式Web应用程序，构建优化器以及与Material Design相关的改进。                                                                                                   |
| 6         | 2018年5月4日   | 这是一个主要版本，更少关注底层框架，更多关于工具链，以及将来更容易使用Angular快速移动                                                                                                     |
| 7         | 2018年10月18日 | 有关应用程序性能，Angular材料和CDK，虚拟滚动，改进的Selects Accessibility的更新，现在支持使用Web标准进行自定义元素的Content Projection，以及有关Typescript 3.1，RxJS 6.3，Node的依赖关系更新10（仍然支持节点8）。  |
| 8         | 2019年5月28日  | 具有所有应用程序代码的差异加载，懒惰路由的动态导入，Web worker，TypeScript 3.4支持和Angular Ivy作为选择预览。                                                                           |
| 9         | 2020年2月     |                                                                                                                                                    |
| 10        | 2020年6月     |                                                                                                                                                    |
| 11        | 2020年11月    |                                                                                                                                                    |
| 12        | 2021年5月     |                                                                                                                                                    |
...
> 1. 从9.0版本开始，Angular团队已经将所有新应用转移到去使用Ivy编译器和运行时。他们将致力于在Ivy上开发，以提高输出包的大小和开发速度。而且每个版本都希望与之前的版本做到兼容。Angular开发团队则承诺每年会进行两次升级。
> 2. 没有Angular 3.0呢？这是因为Angular 2.0一直是一个单一的存储库，每个包都约定好可以使用@angular/package-name来下载，例如@angular/HTTP， @angular/router。在2.0版本里，所有这些包的名称都被指定为版本2，除了路由器包（router）被错误地指定为版本3。因此，开发团队跳过了Angular 3.0，直接将其命名为Angular 4.0，以保持与Angular路由器包版本的兼容性。

### Bootstrap (2011)

Bootstrap来自 Twitter，是目前最受欢迎的前端框架。Bootstrap 是基于 HTML、CSS、JavaScript的，它简洁灵活，使得 Web 开发更加快捷。用于开发响应式布局、移动设备优先的 WEB 项目。
...
4. JSX  −JSX 是 JavaScript语法的扩展。React 开发不一定使用 JSX ，但我们建议使用它。
...
* Bootstrap  http://www.runoob.com/try/Bootstrap
...
* jQuery已“死”？为清除技术债，我们删掉了前端所有jQuery依赖   https://new.qq.com/rain/a/20220520A07O1Q00.html
* Angular各个版本介绍  https://bbs.huaweicloud.com/blogs/349145
...
Node.js® is a platform built on [Chrome's JavaScriptruntime](http://code.google.com/p/v8/) for easily building fast, scalable network applications. Node.js uses an event-driven, non-blocking I/O model that makes it lightweight and efficient, perfect for data-intensive real-time applications that run across distributed devices.
...
# 4 Vue.js
  ...
  Vue官方文档v3中文：https://v3.cn.vuejs.org/

  Vue GitHub地址：https://github.com/vuejs/core/

  在线体验： [Vitejs (forked) - StackBlitz](https://stackblitz.com/edit/vitejs-vite-5henyf?file=index.html&terminal=dev)
...
### 简介&版本
  ...
  Vue 是一款流行的 JavaScript 前端框架，于 2014 年作为独立开源开发者尤雨溪（中国无锡人）的个人项目发布。尤雨溪现通过 Patreon 平台众筹全职开发 Vue 的资金。他曾在 Google 和 Meteor 工作过。

  表格 Vue.js版本说明  [core/CHANGELOG.md at main · vuejs/core · GitHub](https://github.com/vuejs/core/blob/main/CHANGELOG.md)

| 版本                                    | 发布时间       | 说明                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.6.0                                 | 2013-12-8  | github上首个版本。<br>0.x系列最后一个版本是0.12.16(2015-09-26)。                                                                                                                                                                                                                                                                                                          |
| 1.0                                   | 2015-10-27 | 1.x系列最后一个版本是1.0.28(2016-09-28)。                                                                                                                                                                                                                                                                                                                           |
| [2.0](https://github.com/vuejs/vue)   | 2016-10-01 | [2.x系列](https://github.com/vuejs/vue/releases)最后一个版本是2.6.14(2021-1-7)。<br>这个版本开始支持MVVM。                                                                                                                                                                                                                                                                   |
| [3.0](https://github.com/vuejs/core/) | 2020-09-18 | 提供了更好的性能、更小的捆绑包体积、更好的 TypeScript 集成、用于处理大规模用例的新API。 <br>3.0.0共发布alpah-13个，beta-24个，rc-13个版本。于2020-09-18正式发布3.0.0。[3.1.0](https://github.com/vuejs/core/compare/v3.1.0-beta.7...v3.1.0) (2021-06-07), [3.2.0](https://github.com/vuejs/core/compare/v3.2.0-beta.8...v3.2.0) (2021-08-09)<br>Vue 3 将在 2022 年 2 月 7 日成为新的默认版本。`npm install vue` 将默认安装 Vue 3。 |
...
Vue.js 是采用 Object.defineProperty 的 getter 和 setter，并结合观察者模式来实现数据绑定的。当把一个普通 JavaScript对象传给 Vue 实例来作为它的 data 选项时，Vue 将遍历它的属性，用 Object.defineProperty 将它们转为 getter/setter。用户看不到 getter/setter，但是在内部它们让 Vue 追踪依赖，在属性被访问和修改时通知变化。
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [vue-router](https://github.com/vuejs/vue-router)                                         | [![vue-router-status](https://camo.githubusercontent.com/8f9ce0cb8de147c7146010122331865a5ceb2db27f55b4c140265d91e1e687ca/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f7675652d726f757465722e737667)](https://npmjs.com/package/vue-router)                                                                                                                              | Single-page application routing  单页应用路由                 |
| [vuex](https://github.com/vuejs/vuex)                                                     | [![vuex-status](https://camo.githubusercontent.com/93d3bf488bd8e98d03b4df2298f8c9eeb031eb82d8b00b8c6d64646677f11eaa/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f767565782e737667)](https://npmjs.com/package/vuex)                                                                                                                                                      | Large-scale state management  状态管理                      |
| [vue-cli](https://github.com/vuejs/vue-cli)                                               | [![vue-cli-status](https://camo.githubusercontent.com/bb2ec938380e1cd19abd7201474415c200d6f49a9e18998a4fd101587dda5bab/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f407675652f636c692e737667)](https://npmjs.com/package/@vue/cli)                                                                                                                                       | Project scaffolding                                     |
| [vue-loader](https://github.com/vuejs/vue-loader)                                         | [![vue-loader-status](https://camo.githubusercontent.com/de33543b692dfe4ae065fbafc5d2bf101efc13c119ea18bdfb522633a75aef97/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f7675652d6c6f616465722e737667)](https://npmjs.com/package/vue-loader)                                                                                                                              | Single File Component (`*.vue` file) loader for webpack |
| [vue-server-renderer](https://github.com/vuejs/vue/tree/dev/packages/vue-server-renderer) | [![vue-server-renderer-status](https://camo.githubusercontent.com/39b581bc8f7d1bdf580dd8bc12cd34a6f33b4418d52257cc121a19ef2d7859a9/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f7675652d7365727665722d72656e64657265722e737667)](https://npmjs.com/package/vue-server-renderer)                                                                                          | Server-side rendering support  服务端渲染支持                  |
| [vue-class-component](https://github.com/vuejs/vue-class-component)                       | [![vue-class-component-status](https://camo.githubusercontent.com/528a34bdf5fc857da2a9db806d3856d38066096e599700e490a478d002a1485d/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f7675652d636c6173732d636f6d706f6e656e742e737667)](https://npmjs.com/package/vue-class-component)                                                                                          | TypeScript decorator for a class-based API              |
| [vue-rx](https://github.com/vuejs/vue-rx)                                                 | [![vue-rx-status](https://camo.githubusercontent.com/41772c340cd78a1978f21846adcf5969bd0383337a2f98103cc8d763c0008c3f/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f7675652d72782e737667)](https://npmjs.com/package/vue-rx)                                                                                                                                              | RxJS integration                                        |
| [vue-devtools](https://github.com/vuejs/vue-devtools)                                     | [![vue-devtools-status](https://camo.githubusercontent.com/212ed561fc1a5e5e300bcd0e2694a3eb6f9ac4bd304c20f8226e89e1ff850b26/68747470733a2f2f696d672e736869656c64732e696f2f6368726f6d652d7765622d73746f72652f762f6e68646f676a6d656a69676c69706363706e6e6e616e68626c6564616a6270642e737667)](https://chrome.google.com/webstore/detail/vuejs-devtools/nhdogjmejiglipccpnnnanhbledajbpd) | Browser DevTools extension                              |

### vue-cli

github仓库  [vuejs/vue-cli: 🛠️ Standard Tooling for Vue.js Development](https://github.com/vuejs/vue-cli)
...
* Vue 作者尤雨溪，引路中国程序开发  https://blog.csdn.net/yelin042/article/details/107229843

* vue http://www.runoob.com/vue2/vue-tutorial.html

* pycharm新建Vue项目  https://www.cnblogs.com/ppap/p/11189092.html
...
官网中文文档：https://zh-hans.reactjs.org
...
| 17.0   | 2020-10-20 | 1.Add `react/jsx-runtime` and `react/jsx-dev-runtime`<br>2.Build component stacks from native error frames.<br>... | 17.x最新版本是17.0.2(2021-03-22)   |
...
* index.html  首页  定义根元素，导入index.jsx
* index.jsx  导入组件
* App.jsx  定义组件
...
JSX 即JavaScriptXML，它是对JavaScript语法扩展。React 使用 JSX 来替代常规的 JavaScript。当遇到<，JSX就当HTML解析，遇到{就当JavaScript解析。
...
因此，使用 JSX 可以完成的任何事情都可以通过纯 JavaScript完成。
...
React 组件从概念上类似于 JavaScript函数。它接受任意的入参（即 “props”），并返回用于描述页面展示内容的 React 元素。
...
- 只能在 **React 的函数组件**中调用 Hook。不要在其他 JavaScript函数中调用。（还有一个地方可以调用 Hook —— 就是自定义的 Hook 中，我们稍后会学习到。）
...
| 类别     | 插件名称                    | 插件简介                                                                        |
| ------ | ----------------------- | --------------------------------------------------------------------------- |
| 状态管理   | Redux                   | JavaScript状态容器，提供可预测化的状态管理                                                  |
...
| 工具类    | react-copy-to-clipboard | 基于React的复制到剪切板组件                                                            |
...
| 脚手架    | Create React App        | 初学者必备React傻瓜式脚手架                                                            |
...
* [Redux - A predictable state container for JavaScriptapps. | Redux](https://redux.js.org/)   https://redux.js.org/
* 这可能是最通俗易懂的React 渲染原理及性能优化 https://blog.csdn.net/weixin_46837985/article/details/106642294
* ReactDom render原理剖析 https://blog.csdn.net/weixin_33912453/article/details/88028171
* 深入理解ReactDOM.render 是如何串联渲染链路的全过程 https://blog.csdn.net/xgangzai/article/details/117794098
