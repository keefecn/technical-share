...
| 格式  | 简介                                                         | 样例                                                         |
| ----- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| YAML  | [YAML ](http://www.yaml.org/)(Yet Another   Markup Language)，2001年出现首版。<br>适用场景：多层级关系，数组，可定义常量（包括：整数，浮点数，字符串，NULL，日期，布尔，时间）<br>比如docker-compose.yaml。<br>注释用#表示。 | filebeat:<br/>  inputs:<br/>    - type: log  #日志<br/>      paths:<br/>        - /var/log/*.log  <br/>      multiline:<br/>        pattern: '^['<br/>        match: after |
