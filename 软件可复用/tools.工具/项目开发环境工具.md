...
| 名称                                  | 简介                                                         | 配置文件                | 命令                                            | 项目           |
| ------------------------------------- | ------------------------------------------------------------ | ----------------------- | ----------------------------------------------- | -------------- |
| make                                  | unix/linux平台最常见的项目构建工具。                         | Makefile                | make install/clean                              | C/C++项目      |
...
| [maven](http://maven.apache.org)      | 构建工具。                                                   | pom.xm                  | mvm install   mvm clean install   mvm package   | JAVA项目       |
| [Gradle](https://gradle.org)          | Groovy based build system。                                  | x-build.gradle          | $ gradlew   wrapper   $ gradlew   assembleDebug | JAVA项目       |
| [grunt](https://gruntjs.com/)         | 基于Node.js的项目构建工具.                                   | package.json  Gruntfile |                                                 | Node.js        |
| sbt                                   | 项目构建工具                                                 | xx.sbt或   xx.scala     |                                                 | scala          |
