...
Typora 是一款十分简洁的 Markdown 编辑器，支持 Windows、Mac、Linux。但2021.11.23，Typora 正式发布了 1.0.0 版本，并开启付费模式，价格为 89 元，可用 3 台设备，提供免费升级；2022.2.15起，windows旧版本已不可使用，需要换用付费新版本，并且只能试用15天；linux版暂不受影响。开源替换产品是marktext、[trilium](https://github.com/baddate/trilium)。
