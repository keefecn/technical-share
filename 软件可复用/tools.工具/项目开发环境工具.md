...
IntelliJ IDEA分为Ultimate Edition 旗舰版和Community Edition 社区版本，旗舰版可以免费试用30天，社区版本免费使用，但是功能上对比旗舰版有所缩减。<br>
...
* 专业软件包涉及所有高级功能（python+web开发、远程调试），可以免费试用30天，用户必须购买许可密钥才能在试用期之后激活。
...
* Remote Development  支持ssh到远程主机，直接编辑远程主机文件。
...
* VScode Remote 远程开发与调试 [VScode Remote 远程开发与调试 - 简书](https://www.jianshu.com/p/0f2fb935a9a1)
