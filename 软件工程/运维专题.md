...
参见  《[网站优化工具](../tools.工具/网站优化工具.md)》keepalived章节
...
[3]. Keepalive 之高可用实现 https://www.jianshu.com/p/a209cb8ed693?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
...
|          | 工具            | 详介                                                         | 实现原理                                                     |
| -------- | --------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| cpu<br/> | top/vmstat/sar/ | cpu = user + nice + system + idle                            | /proc/stat=100*(user+nice+system)/(user+nice+system+idle)  /proc/cpuinfo |
