...
> 
> [NVIDIA](https://www.nvidia.cn/) : 中文名英伟达。1999年发明了GPU(图形处理器)，也是人工智能计算的引领者。创建了世界上最大的游戏平台和世界上最快的超级计算机。
...
| N/A   33C    P8    15W /  70W |      2MiB / 15360MiB |      0%      Default |
|                               |                      |                  N/A |
+-------------------------------+----------------------+----------------------+
...
参见 《[大数据集群管理.md](../大数据与AI/bigdata/大数据集群管理.md)》 Mesos章节
