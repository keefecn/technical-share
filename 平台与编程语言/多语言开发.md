...
### 4.4.3  cmake/qmake
#### 4.4.3.1 cmake
​         **c****make**是个跨平台的自动化建构系统，它用组态档控制建构过程（build process）的方式和 Unix的Make 相似，只是**Cmake**的组态档取名为CmakeLists.txt。“Cmake”这个名字是 "cross platform make" 的缩写。虽然名字中含有 "make"，但是 CMake 和 Unix 上常见的“make”系统是分开的，而且更为高阶。 
...
[**Pypy Python****的JIT****实现**](http://www.cnblogs.com/hitfire/articles/4502199.html)
