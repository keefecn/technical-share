...
**Servlet****的配置**        编译好的Servlet源文件并不能响应用户请求，还必须将其编译成class文件。将编译后的.class 文件放在WEB-INF/classes路径下，如果Servlet有包，则还应该将class文件放在对应的包路径下。 
...
**3****）****javac****编译出现“****仅当显式请求注释处理时才接受类名称“xxxxxx”“**
