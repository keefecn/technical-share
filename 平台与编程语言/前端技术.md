...
![前端工程化史]( ../media/domain/front_003.png.png)
...
**HTML** **是** **Web** **上的通用标记语言。**早期的HTML语法被定义成较松散的规则，以有助于不熟悉网络出版的人采用。网页浏览器接受了这个现实，并且可以显示语法不严格的网页。使用[XML](http://zh.wikipedia.org/wiki/XML)的严格规则的[XHTML](http://zh.wikipedia.org/wiki/XHTML)（可扩展超文本置标语言）是[W3C](http://zh.wikipedia.org/wiki/W3C)计划中的HTML的接替者。虽然很多人认为它已经成为当前的HTML标准，但是它实际上是一个独立的、和HTML平行发展的标准。[W3C](http://zh.wikipedia.org/wiki/W3C)目前的建议是使用XHTML 1.1、XHTML 1.0或者HTML 4.01进行网络出版。
...
层叠样式表（Cascading Style Sheets，简写为CSS），又称串樣式列表，由[W3C](http://zh.wikipedia.org/wiki/W3C)定义和维护的标准，一种用来为结构化文档（如[HTML](http://zh.wikipedia.org/wiki/HTML)文档或[XML](http://zh.wikipedia.org/wiki/XML)应用）添加样式（字体、间距和颜色等）的[计算机语言](http://zh.wikipedia.org/wiki/计算机语言)。目前最新版本是CSS 2.1，为W3C的候选推荐标准。下一版本CSS 3仍然在开发过程中。
...
-  [W3C  HTML](http://www.w3.org/2005/11/Translations/Lists/ListLang-zh-hans.html)[文档中文翻译](http://www.w3.org/2005/11/Translations/Lists/ListLang-zh-hans.html) http://www.w3.org/2005/11/Translations/Lists/ListLang-zh-hans.html
-  W3CHINA [http://www.w3china.org/index.htm  ](http://www.w3china.org/index.htm 成立于2002)[成立于2002](http://www.w3china.org/index.htm 成立于2002)年.
-  [中国万维网W3C协会](http://www.webw3c.org/) http://www.webw3c.org/ 成立于2008年7月.
