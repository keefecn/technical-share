...
| FTP      | Xftp                   | WinSCP、Filezilla                                                      | WinSCP 是一个 Windows 环境下使用的 SSH 的开源图形化 SFTP 客户端。同时支持 SCP 协议。它的主要功能是在本地与远程计算机间安全地复制文件，并且可以直接编辑文件。                                                                                                                                                                             |
...
| IDE      | IDEA                   | Eclipse                                                               | 其它如VS Code.                                                                                                                                                                                                                                                                |
|          | Anaconda               | Pycharm社区版                                                            |                                                                                                                                                                                                                                                                            |
|          | UltraEdit/<br>Editplus | **Notepad++**                                                         | Notepad++中文版是一款免费开源代码编辑器，Notepad++中文版支持27种语法高亮度显示。                                                                                                                                                                                                                         |
|          | SourceInsight          | TheSource-NavigatorIDE                                                |                                                                                                                                                                                                                                                                            |
| 比对       | Beyond Compare         | [winMerge](https://winmerge.org/downloads/?lang=en)                   | winMerge支持三个文件对比，而且支持表格、图像文件对比，以易于理解和处理的可视化文本格式显示差异。                                                                                                                                                                                                                       |
